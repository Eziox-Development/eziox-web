        ...
        {connection?.connected ? (
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    {connection.showOnProfile
                      ? t('spotify.connect.visibleToVisitors')
                      : t('spotify.connect.activityHidden')}
                  </p>
                </div>
              </div>
            ...
            <p
              ...
              style={{ color: theme.colors.foregroundMuted }}
            >
              {t('spotify.connect.connectedSince')}{' '}
          ...
          <div className="space-y-5">
            ...
            <motion.button
              ...
              whileHover={{
                scale: 1.02,
                y: -2,
                boxShadow: `0 12px 32px ${SPOTIFY_GREEN}50`,
              }}
              whileTap={{ scale: 0.98 }}
            >

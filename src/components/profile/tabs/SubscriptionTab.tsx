    ...
    >
      <motion.div
        ...
        style={{
          ...
          boxShadow: `0 0 40px ${currentStyles.glow}`,
        }}
        initial={{ scale: 0.95 }}
        animate={{ scale: 1 }}
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-3xl font-bold text-white">
                {currentConfig?.name || currentTier}
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  >
                    ...
                    {currentConfig?.billingType === 'monthly' ? '/mo' : ''}
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p
                      ...
                      style={{ color: theme.colors.foregroundMuted }}
                    >
                      Your plan will downgrade to Free after{' '}
                      {formatDate(subscription.currentPeriodEnd)}
                    </p>
                  </div>
                  <motion.button
            ...
            {currentConfig?.features.slice(0, 9).map((feature, i) => (
              ...
              >
                <div
                  ...
                  style={{ background: `${currentStyles.primary}20` }}
                >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  current billing period. After that, you'll be downgraded to
                  the Free plan.
                </p>
                <div className="flex gap-3">
                  <motion.button
                  ...
                  <motion.button
                    ...
                    className="flex-1 py-3 rounded-xl font-medium text-sm text-white flex items-center justify-center gap-2"

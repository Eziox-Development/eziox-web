...
export function CreatorTab() {
  ...
  const [activeSection, setActiveSection] = useState<'css' | 'fonts' | 'animations' | 'opengraph'>('css')
            ...
            <div className="p-5 space-y-4">
              ...
              {settings?.customFonts && settings.customFonts.length > 0 ? (
                ...
                <div className="py-8 text-center">
                  <Type size={32} className="mx-auto mb-3 opacity-30" style={{ color: theme.colors.foregroundMuted }} />
                  <p className="text-sm" style={{ color: theme.colors.foregroundMuted }}>No custom fonts added</p>
                  <p className="text-xs mt-1" style={{ color: theme.colors.foregroundMuted }}>Add up to 4 custom fonts</p>
                </div>
              )}
            </div>
          </motion.div>

  ...
  const stats = useMemo(
    () => ({
      ...
      avgClicks:
        links.length > 0
          ? Math.round(
              links.reduce((sum, l) => sum + (l.clicks || 0), 0) / links.length,
            )
          : 0,
    }),
    [links],
      ...
      >
        {[
          ...
          <motion.div
            ...
            className="relative overflow-hidden p-4 backdrop-blur-xl border border-border/50"
            style={{
      ...
      >
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="newest">
                {t('shortener.sort.newest')}
              </SelectItem>
              <SelectItem value="oldest">
                {t('shortener.sort.oldest')}
              </SelectItem>
              <SelectItem value="mostClicks">
                {t('shortener.sort.mostClicks')}
              </SelectItem>
              <SelectItem value="leastClicks">
                {t('shortener.sort.leastClicks')}
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <button
          ...
          style={{
            ...
            boxShadow:
              glowOpacity > 0
                ? `0 4px 20px ${theme.colors.primary}${Math.round(
                    glowOpacity * 200,
                  )
                    .toString(16)
                    .padStart(2, '0')}`
        ...
        {isLoading ? (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-foreground mb-2">
              {t('shortener.empty.title')}
            </h3>
            <p className="text-foreground-muted mb-6 max-w-sm mx-auto">
              {t('shortener.empty.description')}
            </p>
            <button
              onClick={() => setShowCreateModal(true)}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      >
                        {link.isActive
                          ? t('shortener.link.active')
                          : t('shortener.link.inactive')}
                      </span>
                    </div>
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <div className="flex items-center gap-1.5 text-foreground-muted">
                      ...
                      <span>
                        {(link.clicks || 0) === 1
                          ? t('shortener.link.click')
                          : t('shortener.link.clicks')}
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5 text-foreground-muted">
                      <Clock size={14} />
              ...
              <form onSubmit={handleCreateSubmit} className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCreateForm((prev) => ({
                          ...prev,
                          customCode: e.target.value.replace(
                            /[^a-zA-Z0-9_-]/g,
                            '',
                          ),
                        }))
                  ...
                  <p className="text-xs text-foreground-muted mt-1">
                    {t('shortener.create.customCodeHint')}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <DateTimePicker
                    ...
                    placeholder={t('shortener.create.expiresAtPlaceholder', 'Select expiration date')}
                  />
                </div>

...
export function IntegrationsTab() {
  ...
  const toggleVisibilityMutation = useMutation({
    mutationFn: ({ platform, show }: { platform: SupportedPlatform; show: boolean }) =>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: theme.colors.foreground }}>
                {connectedPlatforms.length}/{SUPPORTED_PLATFORMS.length} {t('integrations.connected_count')}
              </span>
            </div>
          </div>
        </div>
        ...
        {SUPPORTED_PLATFORMS.map((platformId, index) => {
          ...
          return (
            <motion.div
              ...
              style={{
                borderColor: connected ? theme.colors.primary + '50' : theme.colors.border + '50',
                ...
                <div className="flex items-start gap-4">
                  <motion.div
                    ...
                    style={{ 
                      ...
                      boxShadow: connected ? `0 0 20px ${platform.color}20` : 'none'
                    }}
                  >
                    <Icon 
                      className="h-6 w-6" 
                    ...
                    >
                      <div className="flex items-center gap-2">
                        {connection?.showOnProfile ? (
                          <Eye className="h-4 w-4" style={{ color: theme.colors.primary }} />
                        ) : (
                          <EyeOff className="h-4 w-4" style={{ color: theme.colors.foregroundMuted }} />
                        )}
        ...
        <div className="p-5 grid gap-4 sm:grid-cols-3">
          ...
          <div className="flex items-start gap-3">
            <div 
              ...
              style={{ backgroundColor: theme.colors.primary + '10' }}
            >
              <KeyRound className="h-4 w-4" style={{ color: theme.colors.primary }} />
            </div>
            <div>
              <p 
                className="text-sm font-medium"
          ...
          <div className="flex items-start gap-3">
            <div 
              ...
              style={{ backgroundColor: theme.colors.primary + '10' }}
            >
              <Unlink className="h-4 w-4" style={{ color: theme.colors.primary }} />
            </div>
            <div>
              <p 
                className="text-sm font-medium"
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t('integrations.disconnect_confirm.description', {
                platform: disconnectPlatform ? PLATFORM_CONFIG[disconnectPlatform]?.name : '',
              })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => disconnectPlatform && disconnectMutation.mutate(disconnectPlatform)}

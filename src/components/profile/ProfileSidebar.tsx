    ...
    >
      ...
      >
        <div className="p-5 border-b" style={{ borderColor: theme.colors.border }}>
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold truncate" style={{ color: theme.colors.foreground }}>
        ...
        <nav className="p-3">
          ...
          <QuickLink to="/$username" params={{ username: currentUser.username }} icon={Globe} label="My Bio Page" external />
          ...
          <QuickLink to="/theme-builder" icon={Paintbrush} label="Theme Builder" premium />
        </nav>
          ...
          <div className="p-4 border-t" style={{ borderColor: theme.colors.border }}>
            ...
            <nav className="space-y-1">
              ...
              >
                ...
                <span className="text-sm" style={{ color: theme.colors.foreground }}>Admin Panel</span>
                <ChevronRight size={14} className="ml-auto" style={{ color: theme.colors.foregroundMuted }} />
              </Link>
              <Link
              ...
              >
                ...
                <span className="text-sm" style={{ color: theme.colors.foreground }}>Partner Apps</span>
                <ChevronRight size={14} className="ml-auto" style={{ color: theme.colors.foregroundMuted }} />
              </Link>
            </nav>
          </div>
        ...
        <div className="p-4 border-t" style={{ borderColor: theme.colors.border }}>
          ...
          <div className="flex items-center gap-2">
            <div
              ...
              style={{ background: theme.colors.backgroundSecondary, color: accentColor }}
            >
            ...
            >
              {copied ? (
                ...
                <Copy size={18} style={{ color: theme.colors.foregroundMuted }} />
              )}
            </button>
          </div>
        </div>
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: isActive ? accentColor : theme.colors.backgroundSecondary }}
      >
        <Icon size={18} style={{ color: isActive ? 'white' : theme.colors.foregroundMuted }} />
      </div>
      <span
        className="flex-1 text-left text-sm"
        style={{ color: isActive ? theme.colors.foreground : theme.colors.foregroundMuted }}
      >
        {tab.label}
      </span>
...
function QuickLink({
  ...
  return (
    ...
    >
      ...
      >
        <Icon size={18} style={{ color: premium ? 'white' : theme.colors.foregroundMuted }} />
      </div>
      <span style={{ color: theme.colors.foreground }}>{label}</span>
      {external && <ExternalLink size={14} style={{ color: theme.colors.foregroundMuted }} />}

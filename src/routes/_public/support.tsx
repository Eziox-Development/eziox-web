...
function SupportPage() {
  ...
  const categories: Category[] = useMemo(
    () => [
      {
        id: 'general',
        label: t('support.categories.general.label', 'General Inquiry'),
        description: t('support.categories.general.description', 'Questions about Eziox'),
        icon: HelpCircle,
        color: '#6366f1',
        responseTime: '24-48h',
        examples: ['How does X work?', 'What features are included?'],
      },
      {
        id: 'technical',
        label: t('support.categories.technical.label', 'Technical Support'),
        description: t('support.categories.technical.description', 'Bugs, errors, and issues'),
        icon: Bug,
        color: '#ef4444',
        responseTime: '12-24h',
        examples: ['Page not loading', 'Feature not working'],
      },
      {
        id: 'billing',
        label: t('support.categories.billing.label', 'Billing & Payments'),
        description: t('support.categories.billing.description', 'Subscriptions and invoices'),
        icon: CreditCard,
        color: '#22c55e',
        responseTime: '24-48h',
        examples: ['Payment failed', 'Need invoice'],
      },
      {
        id: 'account',
        label: t('support.categories.account.label', 'Account Issues'),
        description: t('support.categories.account.description', 'Login, password, settings'),
        icon: UserCog,
        color: '#06b6d4',
        responseTime: '24-48h',
        examples: ["Can't login", 'Change email'],
      },
      {
        id: 'security',
        label: t('support.categories.security.label', 'Security Report'),
        description: t('support.categories.security.description', 'Report vulnerabilities'),
        icon: Shield,
        color: '#8b5cf6',
        responseTime: 'Priority',
        examples: ['Found a bug', 'Security concern'],
      },
      {
        id: 'abuse',
        label: t('support.categories.abuse.label', 'Report Abuse'),
        description: t('support.categories.abuse.description', 'Report harmful content'),
        icon: AlertTriangle,
        color: '#f59e0b',
        responseTime: '12-24h',
        examples: ['Spam profile', 'Malicious links'],
      },
      {
        id: 'legal',
        label: t('support.categories.legal.label', 'Legal Request'),
        description: t('support.categories.legal.description', 'Legal inquiries'),
        icon: Scale,
        color: '#64748b',
        responseTime: '3-5 days',
        examples: ['Trademark issue', 'Legal question'],
      },
      {
        id: 'partnership',
        label: t('support.categories.partnership.label', 'Partnership'),
        description: t('support.categories.partnership.description', 'Business inquiries'),
        icon: Handshake,
        color: '#14b8a6',
        responseTime: '3-5 days',
        examples: ['Collaboration', 'Integration'],
      },
      {
        id: 'feature',
        label: t('support.categories.feature.label', 'Feature Request'),
        description: t('support.categories.feature.description', 'Suggest improvements'),
        icon: Sparkles,
        color: '#f97316',
        responseTime: 'Reviewed',
        examples: ['New feature idea', 'Improvement'],
      },
      {
        id: 'withdrawal',
        label: t('support.categories.withdrawal.label', 'Withdrawal Request'),
        description: t('support.categories.withdrawal.description', 'Cancel subscription or refund'),
        icon: Undo2,
        color: '#dc2626',
        responseTime: '14 days',
        examples: ['Cancel subscription', 'Request refund'],
      },
      {
        id: 'dmca',
        label: t('support.categories.dmca.label', 'DMCA Takedown'),
        description: t('support.categories.dmca.description', 'Copyright infringement'),
        icon: FileText,
        color: '#7c3aed',
        responseTime: '24-48h',
        examples: ['My content stolen', 'Copyright claim'],
      },
      {
        id: 'gdpr',
        label: t('support.categories.gdpr.label', 'GDPR Request'),
        description: t('support.categories.gdpr.description', 'Data privacy requests'),
        icon: Trash2,
        color: '#0ea5e9',
        responseTime: '30 days',
        examples: ['Delete my data', 'Export my data'],
      },
    ],
    [t],
  )

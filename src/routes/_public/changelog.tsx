...
const changelog: ChangelogEntry[] = [
  {
    ...
    description: 'Complete email verification system, modern bio page schema with media embeds, link groups, widgets, and social integrations. Cleaned up deprecated features.',
    icon: Shield,
    type: 'feature',
    highlights: [
    ...
    changes: [
      { type: 'feature', text: 'Email verification system with /verify-email route' },
      { type: 'feature', text: 'Media embeds - Spotify, SoundCloud, YouTube, Twitch, TikTok, Apple Music' },
      ...
      { type: 'feature', text: 'Social integrations - Connect YouTube, Twitch, TikTok accounts' },
      ...
      { type: 'improvement', text: 'Updated Privacy Policy with IP anonymization details' },
  ...
  },
  {
    ...
    description: 'Complete overhaul of subscription tiers with expanded free tier and fair pricing. Modular profile architecture with better code organization. Redesigned public pages with "no paywalls" philosophy.',
    icon: Crown,
    type: 'improvement',
    highlights: [
    ...
    changes: [
      { type: 'improvement', text: 'Free tier expanded - unlimited links, all themes, all backgrounds, full analytics' },
      { type: 'improvement', text: 'Pro tier $2.99 - Custom CSS, fonts, backups, remove branding' },
      { type: 'improvement', text: 'Creator tier $5.99 - Custom domain, password links, email collection' },
      { type: 'improvement', text: 'Lifetime tier $29 - One payment, all features forever' },
      { type: 'improvement', text: 'Modular profile system - ProfileDashboard, Sidebar, Header, Stats' },
      { type: 'improvement', text: 'Profile route optimized from 461 to 22 lines' },
      { type: 'improvement', text: 'Centralized constants and types for better maintainability' },
      { type: 'improvement', text: 'About page redesigned with "no paywalls" messaging' },
      { type: 'improvement', text: 'Homepage performance optimizations' },
      { type: 'fix', text: 'Removed artificial limits on links, themes, and analytics' },
      { type: 'fix', text: 'Fixed TypeScript errors in CustomizationTab' },
      { type: 'fix', text: 'Cleaned up LinkAdvancedSettings (removed A/B testing, UTM, embed controls)' },
    ],
  },
  {
    version: '2.3.0',
  ...
  },
  {
    ...
    description: 'Complete implementation of Creator tier with custom CSS, fonts, animations, advanced link features, and Pro tier enhancements.',
    icon: Palette,
    type: 'feature',
    highlights: [
    ...
    changes: [
      { type: 'feature', text: 'Custom CSS Editor with sandboxed validation and forbidden pattern detection' },
      { type: 'feature', text: 'Custom Font Uploads - up to 4 fonts with Google Fonts support' },
      { type: 'feature', text: 'Animated Profiles - avatar, banner, link hover, and page transition effects' },
      { type: 'feature', text: 'Custom Open Graph previews for social sharing' },
      { type: 'feature', text: 'Featured Links with 5 special styles (glow, gradient, outline, neon)' },
      { type: 'feature', text: 'Link Scheduling with start/end dates and timezone support' },
      { type: 'feature', text: 'A/B Testing for links - compare up to 4 variants with click tracking' },
      { type: 'feature', text: 'UTM Parameters for marketing campaign tracking' },
      { type: 'feature', text: 'Advanced Embed Controls for Spotify, YouTube, SoundCloud' },
      { type: 'feature', text: '6 Premium Themes: Ocean Depths, Forest Night, Neon Tokyo, Pastel Dream, Monochrome Pro, Aurora' },
      { type: 'feature', text: 'Custom Backgrounds (solid, gradient, image) for Pro tier' },
      { type: 'feature', text: 'Layout Fine-Tuning with spacing, border-radius, and shadow controls' },
      { type: 'feature', text: 'Profile Backups & Restore functionality' },
      { type: 'improvement', text: 'Theme switcher now shows premium badges and tier-locks' },
      { type: 'improvement', text: 'LinksTab enhanced with advanced settings modal' },
      { type: 'improvement', text: 'Creator tab integrated in profile dashboard' },
      { type: 'security', text: 'CSS sanitization with forbidden pattern detection' },
      { type: 'security', text: 'Tier-based access control on all Creator features' },
    ],
  },
  {
    version: '1.7.0',
  ...
  },
  {
    ...
    description: 'Complete Spotify OAuth integration with live playback display on bio pages.',
    icon: MonitorPlay,
    type: 'feature',
    highlights: [
    ...
    changes: [
      { type: 'feature', text: 'SpotifyConnect component in profile settings for account linking' },
      { type: 'feature', text: 'NowPlaying widget with album art, progress bar, and live updates' },
      { type: 'feature', text: 'Sound bars animation when music is playing' },
      { type: 'feature', text: 'Offline/Not listening state with breathing animation' },
      { type: 'feature', text: 'Direct link to Spotify track for easy access' },
      { type: 'feature', text: 'Privacy toggle to control visibility on profile' },
      { type: 'security', text: 'Secure token storage with automatic refresh handling' },
      { type: 'fix', text: 'Fixed API route structure for production deployment' },
      { type: 'improvement', text: 'Theme-aware styling across all Spotify components' },
    ],
  },
  {
    version: '1.4.2',

...
const changelog: ChangelogEntry[] = [
  {
    ...
    type: 'improvement',
    items: [
      'Redesigned Homepage with live real-time stats',
      'New Profile page with real-time data',
      'Redesigned Links manager with stats grid',
      'Updated Referrals dashboard with glow effects',
      'New About, Changelog, Leaderboard pages',
      'Animated background effects throughout',
      'Referral system now uses URL params (?referral=code)',
    ],
  },
  {
    version: '1.2.0',

...
const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    description: 'Modern glassmorphism design across all pages.',
    icon: Palette,
    type: 'improvement',
    items: [
      'New Profile page with real-time stats',
  ...
  },
  {
    ...
    description: 'Compete with other creators and climb the ranks.',
    icon: Star,
    type: 'feature',
    items: [

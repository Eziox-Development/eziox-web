...
const timeline = [
  {
    ...
    description: 'Complete redesign of user bio pages with modern layout, no Nav/Footer, animated backgrounds, and share functionality.',
    icon: Palette,
    type: 'major',
  },
  {
    ...
    description: 'New /links page for managing bio links with create, edit, delete, and toggle visibility features.',
    icon: LinkIcon,
    type: 'feature',
  },
  {
    ...
    description: 'Auth pages now show real-time stats from database instead of fake placeholder data.',
    icon: Zap,
    type: 'feature',
  },
  {
    ...
    description: 'Redesigned Sign In and Sign Up pages with split-screen layout and trust badges.',
    icon: Shield,
    type: 'feature',
  },
  {
  ...
  },
  {
    ...
    description: 'Successfully migrated from Appwrite to Neon PostgreSQL with Drizzle ORM.',
    icon: Database,
    type: 'feature',
  },
  {
  ...
  },
  {
    ...
    description: 'Initial creation of the portfolio project for personal use.',
    icon: Rocket,
    type: 'major',
  },
]

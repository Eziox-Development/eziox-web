  ...
  themes: [
    ...
    // === PREMIUM THEMES ===
    {
      ...
      typography: {
        ...
        bodyFontUrl: 'https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700&display=swap',
      },
      effects: { glowIntensity: 'medium', borderRadius: 'rounded', cardStyle: 'glass', animationSpeed: 'normal' },
    },
    {
      ...
      name: 'Forest Night',
      category: 'general',
      description: 'Mystical forest greens with moonlit accents',
      isPremium: true,
      colors: {
        background: '#0a1a14',
        backgroundSecondary: '#0f2a1f',
        foreground: '#d1fae5',
        foregroundMuted: '#6ee7b7',
        primary: '#10b981',
        primaryForeground: '#ffffff',
        accent: '#34d399',
        accentForeground: '#0a1a14',
        border: '#064e3b',
        card: '#0f2a1f',
      ...
      typography: {
        ...
        displayFontUrl: 'https://fonts.googleapis.com/css2?family=Fraunces:wght@400;500;600;700;800&display=swap',
        bodyFontUrl: 'https://fonts.googleapis.com/css2?family=Atkinson+Hyperlegible:wght@400;700&display=swap',
      },
      effects: { glowIntensity: 'subtle', borderRadius: 'rounded', cardStyle: 'gradient', animationSpeed: 'slow' },
    },
    {
      id: 'neon-tokyo',
      name: 'Neon Tokyo',
      category: 'gamer',
      description: 'Vibrant neon cityscape aesthetic',
      isPremium: true,
      colors: {
        background: '#0a0a0f',
        backgroundSecondary: '#12121a',
        foreground: '#f0f0ff',
        foregroundMuted: '#a0a0c0',
        primary: '#f43f5e',
        primaryForeground: '#ffffff',
        accent: '#8b5cf6',
        accentForeground: '#ffffff',
    ...
    },
    {
      ...
      colors: {
        background: '#1a1520',
        backgroundSecondary: '#251f2a',
        foreground: '#fce7f3',
        foregroundMuted: '#f9a8d4',
        primary: '#ec4899',
        primaryForeground: '#ffffff',
        accent: '#a78bfa',
        accentForeground: '#1a1520',
      ...
      typography: {
        ...
        bodyFontUrl: 'https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@300;400;500;600;700&display=swap',
      },
      effects: { glowIntensity: 'subtle', borderRadius: 'pill', cardStyle: 'glass', animationSpeed: 'slow' },
    },
    {
      ...
      name: 'Monochrome Pro',
      category: 'minimal',
      description: 'Sophisticated grayscale with subtle accents',
      isPremium: true,
      colors: {
        background: '#0a0a0a',
        backgroundSecondary: '#141414',

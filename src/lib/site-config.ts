...
export const siteConfig: SiteConfig = {
  ...
  themes: [
    // === EZIOX SIGNATURE THEME ===
    {
      ...
      name: 'Eziox',
      category: 'general',
      description: 'The signature Eziox experience — aurora-inspired, bold, and unforgettable',
      colors: {
        background: '#05050a',
        backgroundSecondary: '#0a0b14',
        foreground: '#f0f0ff',
        foregroundMuted: '#8b8fa8',
        primary: '#7c3aed',
      ...
      typography: {
        displayFont: "'Sora', 'Plus Jakarta Sans', sans-serif",
